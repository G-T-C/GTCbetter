layui.config({
    ...
    //添加
    $(".nodeAdd_btn").click(function(){
        var index = layui.layer.open({
            title : "添加节点",
            type : 2,
            content : "/admin/node/addnode",
    ...
    form.on('switch(switchTest)', function(data){
        ...
        // alert(data.id);
                        ...
                        var index = layui.layer.open({
                            title : "节点修改",
                            type : 2,
                            content : "/admin/node/editnode?id="+data.id,
                            success : function(layero, index){
                                setTimeout(function(){
                                    layui.layer.tips('点击此处返回用户列表', '.layui-layer-setwin .layui-layer-close', {
                                        tips: 3
