layui.config({
    ...
    table.render({
        elem: '#list'
        , height: 'full-10'
        , url: '/admin/Recharge/houtaiwalletList' //数据接口
        , page: true //开启分页
        ,limit : 40
        , cols: [[ //表头
            ...
            , {field: 'money', title: '数量', sort: true,}
            , {field: 'before_wallet', title: '原有GK', sort: true,}
            , {field: 'now_wallet', title: '现有GK', sort: true,}
        ...
        $('.search_btn').click(function () {
            ...
            table.reload('list', {
                 ...
                 url: '/admin/Recharge/houtaiwalletList'
